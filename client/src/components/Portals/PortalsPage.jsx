...
const Item = styled.div`
  background-color: ${(props) => props.bg || '#070156'};
  text-align: center;
  padding: 2rem;
  color: #ffffff;
  margin: 2rem;
  ...
  justify-content: center;
  align-items: center;
  border-radius: 100px 48px 100px 2px;
  -moz-border-radius: 100px 48px 100px 2px;
  -webkit-border-radius: 100px 48px 100px 2px;
  ...
  &:hover {
    ...
    color: ${(props) => props.bg || '#070156'};
    border: 2px solid ${(props) => props.bg || '#070156'};
  }
`
